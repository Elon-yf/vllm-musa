...
_SHADOW_MODULES = [
    ...
    ("5", "vllm_musa/distributed/device_communicators/quick_all_reduce.py", "vllm/distributed/device_communicators/quick_all_reduce.py", "shadow (sim 0.05)"),
    ...
    ("5", "vllm_musa/model_executor/layers/rotary_embedding/base.py", "vllm/model_executor/layers/rotary_embedding/base.py", "OOT subclass/register seam"),
    ("5", "vllm_musa/model_executor/layers/utils.py", "vllm/model_executor/layers/utils.py", "shadow (sim 0.04)"),
    ("5", "vllm_musa/model_executor/warmup/deep_gemm_warmup.py", "vllm/model_executor/warmup/deep_gemm_warmup.py", "shadow (sim 0.02)"),
    ("5", "vllm_musa/v1/attention/backends/fa_utils.py", "vllm/v1/attention/backends/fa_utils.py", "shadow (sim 0.03)"),
    ("5", "vllm_musa/v1/attention/backends/mla/common.py", None, "new MUSA module (no upstream)"),
    ("5", "vllm_musa/v1/attention/backends/mla/flashmla_sparse.py", "vllm/v1/attention/backends/mla/flashmla_sparse.py", "OOT subclass/register seam"),
    ("5", "vllm_musa/v1/attention/backends/tree_attn.py", None, "new MUSA module (upstream deleted TREE_ATTN at v0.22)"),
    ("5", "vllm_musa/v1/attention/backends/turboquant.py", None, "new MUSA module (no upstream)"),
    ("5", "vllm_musa/v1/attention/ops/flashmla.py", "vllm/v1/attention/ops/flashmla.py", "shadow (sim 0.06)"),
    ("5", "vllm_musa/v1/executor/multiproc_executor.py", "vllm/v1/executor/multiproc_executor.py", "rebinds upstream (sim 0.08) — 4b-conversion candidate"),
    ("5", "vllm_musa/v1/sample/topk_topp_sampler.py", "vllm/v1/sample/ops/topk_topp_sampler.py", "shadow (sim 0.05)"),
    ("5", "vllm_musa/v1/spec_decode/utils.py", "vllm/v1/spec_decode/utils.py", "shadow (sim 0.24)"),
    ("5", "vllm_musa/worker.py", None, "new MUSA module (no upstream same-path; MTGPUWorker)"),
]
